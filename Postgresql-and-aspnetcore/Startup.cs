...
namespace Postgresql_and_aspnetcore
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            string[] strConn = _defaultConnection.Split(delimitersChars);
            ...
            // montando a string de conexão que o Entity Framework vai usar
            ...
            // Usando o Postgresql no dbContext
